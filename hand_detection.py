...
detection_graph, sess = detector_utils.load_inference_graph()   #Graphs means my model
...
if __name__ == '__main__':
    ...
    score_thresh = 0.80      #Thresold value is a assignment of pixel value in relation
    #If pixel value is smaller than threshold,it set to 0,otherwise it set max.value
